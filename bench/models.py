...
class JournalSmall(JournalSmallBase):
    ...


class JournalSmallFk(JournalSmallBase):
    parent = fields.ForeignKeyField("models.JournalSmallFk", related_name="children", null=True)
